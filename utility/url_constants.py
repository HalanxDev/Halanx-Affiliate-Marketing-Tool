...
TENANT_REFERRAL_BULK_CREATE_LEAD_API_URL = TENANT_REFERRAL_CREATE_LEAD_API_URL + 'bulk/'
OWNER_REFERRAL_BULK_CREATE_LEAD_API_URL = OWNER_REFERRAL_CREATE_LEAD_API_URL + 'bulk/'
